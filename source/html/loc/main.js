...
/*
let latitude =0;
let json_data1 = JSON.stringify (latitude);
console.log(json_data1);
//const position = JSON.parse()
let longitude =0;
let json_data2 = JSON.stringify (longitude);
console.log(json_data2);
*/
window.onload = () => {
    const latitude = 0;
    const longitude = 0;
    const json_data1 = JSON.stringify(latitude, longitude);
    ...
    (() => {
        ...
        let init = async () => {
            ...
            db.data.forEach((item, i) => {
                ...
                //console.log('json_data2:'+json_data2);
                //33.450701, 126.570667
                // 커스텀 오버레이에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
                //let temp_html;

                const temp_html = `<div class="customoverlay">
                        <a href="https://map.kakao.com/link/map/${name},${(latitude,longitude)}  "target="_blank">
